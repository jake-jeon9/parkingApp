...
public class CalendarHelper {
    ...
    public String getCurrentTimeNoType() {
        calendar = Calendar.getInstance();
        int yy = calendar.get(Calendar.YEAR);
        int mm = calendar.get(Calendar.MONTH) + 1;
        int dd = calendar.get(Calendar.DAY_OF_MONTH);
        String currentTime = String.format("%04d-%02d-%02d", yy,mm, dd);
    ...
    public String getReqular(String uploadedTime) {
        ...
        String time_text = DateFormat.format("yyyy/MM/dd", beforeTime).toString();
